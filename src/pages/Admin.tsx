...
function deserializeAll(s: Record<string, string>) {
  const branding: Record<string, string> = { site_name: s.site_name||'BYD Giveaway', logo_url: s.logo_url||'', hero_image_url: s.hero_image_url||'', cashapp_tag: s.cashapp_tag||'', paypal_tag: s.paypal_tag||'' };
...
export default function Admin() {
  ...
  const [branding, setBranding] = useState<Record<string, string>>({ site_name: 'BYD Giveaway', logo_url: '', hero_image_url: '', cashapp_tag: '', paypal_tag: '' });
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-2"><Car className="w-5 h-5 text-red-600" /><h2 className="text-lg font-bold text-gray-900">BYD Car Models & Delivery Fees</h2></div>
