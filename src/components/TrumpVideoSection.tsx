...
import { Check, ThumbsUp, ThumbsDown, Share2, Download, MessageCircle } from 'lucide-react';
        ...
        <div className="max-w-sm mx-auto md:max-w-md">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-red-900/30 border border-gray-800 bg-black">
            <div className="relative w-full" style={{ paddingBottom: '177.78%' }}>
              <iframe
                src="https://www.youtube.com/embed/NlVFzOjh6FI?rel=0&modestbranding=1&fs=1&playsinline=1"
                title="BYD Official Announcement"
          ...
          <div className="mt-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <p className="text-white text-sm font-bold">BYD Auto Official</p>
                <p className="text-gray-400 text-xs">12.4M subscribers</p>
              </div>
            </div>
            <button
