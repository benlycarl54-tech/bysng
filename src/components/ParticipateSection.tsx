...
const DEFAULT_CARS = [
  { index: 0, name: "BYD Seal", year: "2025", tier: "Performance Sedan", fee: "$299", delivery: "7–10 Business Days", range: "570 km Range", power: "390 kW Dual Motor", color: "from-gray-900 to-gray-800", badge: "🏆 Most Popular", badgeColor: "bg-yellow-400 text-yellow-900", img: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69aaf36e7cb88f68a01d7103/fc7c3ae25_IMG-20260306-WA0536.jpg" },
  { index: 1, name: "BYD Atto 3", tier: "Premium SUV", year: "2025", fee: "$349", delivery: "5–7 Business Days", range: "480 km Range", power: "150 kW Electric", color: "from-sky-800 to-sky-900", badge: "⚡ Express Delivery", badgeColor: "bg-blue-500 text-white", img: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69aaf36e7cb88f68a01d7103/397f76f88_IMG-20260306-WA0533.jpg" },
  { index: 2, name: "BYD Han EV", tier: "Luxury Flagship", year: "2025", fee: "$399", delivery: "3–5 Business Days", range: "605 km Range", power: "380 kW Quad Motor", color: "from-red-800 to-red-900", badge: "👑 Premium", badgeColor: "bg-purple-500 text-white", img: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69aaf36e7cb88f68a01d7103/3bf711821_IMG-20260306-WA0532.jpg" },
  { index: 3, name: "BYD Dolphin", tier: "Smart Compact", year: "2025", fee: "$249", delivery: "10–14 Business Days", range: "427 km Range", power: "130 kW Electric", color: "from-emerald-700 to-emerald-900", badge: "💚 Best Value", badgeColor: "bg-green-500 text-white", img: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69aaf36e7cb88f68a01d7103/4a267b535_IMG-20260306-WA0530.jpg" },
  { index: 4, name: "BYD Sea Lion 07", tier: "Sport SUV", year: "2025", fee: "$379", delivery: "5–8 Business Days", range: "520 km Range", power: "310 kW AWD", color: "from-violet-800 to-violet-900", badge: "🔥 New Arrival", badgeColor: "bg-orange-500 text-white", img: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69aaf36e7cb88f68a01d7103/2eaef0a2d_IMG-20260306-WA0529.jpg" },
  { index: 5, name: "BYD Yangwang U7", tier: "Ultra Luxury", year: "2025", fee: "$499", delivery: "3–5 Business Days", range: "680 km Range", power: "960 kW Quad Motor", color: "from-slate-800 to-slate-900", badge: "💎 Ultra Luxury", badgeColor: "bg-yellow-500 text-black", img: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69aaf36e7cb88f68a01d7103/e8b958f38_IMG-20260306-WA0528.jpg" },
  { index: 6, name: "BYD Seagull", tier: "City EV", year: "2025", fee: "$199", delivery: "10–14 Business Days", range: "405 km Range", power: "55 kW Electric", color: "from-cyan-700 to-cyan-900", badge: "🌊 City Special", badgeColor: "bg-cyan-400 text-cyan-900", img: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69aaf36e7cb88f68a01d7103/e9f6841f6_IMG-20260306-WA0531.jpg" },
  { index: 7, name: "BYD Sealion 6", tier: "Family SUV", year: "2025", fee: "$329", delivery: "7–10 Business Days", range: "500 km Range", power: "204 kW PHEV", color: "from-indigo-800 to-indigo-900", badge: "👨‍👩‍👧 Family Pick", badgeColor: "bg-pink-500 text-white", img: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69aaf36e7cb88f68a01d7103/99f4dd363_IMG-20260306-WA0529.jpg" },
  { index: 8, name: "BYD Seal U", tier: "Executive SUV", year: "2025", fee: "$359", delivery: "5–7 Business Days", range: "543 km Range", power: "230 kW PHEV", color: "from-zinc-700 to-zinc-900", badge: "⭐ Top Rated", badgeColor: "bg-amber-400 text-amber-900", img: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69aaf36e7cb88f68a01d7103/c66fcf75c_IMG-20260306-WA0534.jpg" },
];
  ...
  return (
    <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col">
      <div className={`bg-gradient-to-br ${car.color} p-5 relative`}>
        ...
        <img src={car.img} alt={car.name} className="w-full h-40 object-cover rounded-xl mt-3 border-2 border-white/20" />
      </div>
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 mt-4 text-lg max-w-2xl mx-auto">
            BYD is gifting brand new electric vehicles to participants worldwide.
          </p>
        ...
        <div className="mt-10 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-3xl p-8 text-center shadow-xl">
          ...
          <p className="text-red-100 text-base max-w-3xl mx-auto leading-relaxed">
            BYD is the world's <strong>#1 electric vehicle manufacturer</strong>. Each participant is eligible for <strong>one vehicle only</strong>.
          </p>
        </div>
      </div>
    </section>
