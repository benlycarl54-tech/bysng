// localStorage-based data service replacing base44 entities

const SITE_SETTINGS_KEY = 'byd_site_settings';
const PAYMENT_SUBMISSIONS_KEY = 'byd_payment_submissions';
